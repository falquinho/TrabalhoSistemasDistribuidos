...
#define SUCCESS_MKDIR 234
#define SUCCESS_MKFILE 1333
#define SUCCESS_RMFILE 134
#define ELECTION_START 789
#define ELECTION_VOTE 899
#define ELECTION_FINISH 257
#define ELECTION_QUIT 411
